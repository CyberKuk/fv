...
trait Where {
    ...
    final public function andWhere( $statement, array $params = null ){
        if( is_string($statement) ){
            ...
            throw new \Bundle\fv\ModelBundle\Exception\QueryException( "Unknown where statement type " . gettype($statement) );
        }
    ...
    final public function andWhereIn( $field, array $array, $positive = true ){
        if( empty($field) )
            throw new \Bundle\fv\ModelBundle\Exception\QueryException("Where field can not be empty!");
    ...
    private function createNamedParams( $statement, $params, $keyBase ){
        ...
        while( strpos($statement, "?") !== false ){
            if( !isset( $params[$key] ) )
                throw new \Bundle\fv\ModelBundle\Exception\QueryException("Number of params not agreed with given statement");
