...
use Bundle\fv\Storage\Exception\StorageException;
...
class SharedMemory implements Storage {
    ...
    public static function build(\fv\Collection $config) {
        ...
        if( !function_exists("shmop_open") )
            throw new \Bundle\fv\Storage\Exception\StorageInstantiateException("Function shmop_open is undefined. Is PHP_SHMOD extension enabled?");
